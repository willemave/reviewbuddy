...
* **Webpage fetching**: Use inbuilt webpage fetching tools to resolve URLs when needed, or use Exa contents fetching (https://docs.exa.ai/reference/get-contents) via MCP tool `mcp__exa__web_search_exa`.
